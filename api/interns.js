  ...
  try {
    ...
    const interns = allResults.map((page) => {
      ...
      return {
        ...
        heures: p["Heures par semaine"]?.number,
        lundi: p["Disponible lundi"]?.checkbox || false,
        mardi: p["Disponible mardi"]?.checkbox || false,
        mercredi: p["Disponible mercredi"]?.checkbox || false,
        jeudi: p["Disponible jeudi"]?.checkbox || false,
        vendredi: p["Disponible vendredi"]?.checkbox || false,
